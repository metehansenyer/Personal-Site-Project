        ...
        <div className="bg-(--nav-background-color) rounded-(--border-radius-medium) p-6 shadow-lg text-center space-y-6">
          ...
          <div className="flex items-center justify-center gap-6 text-lg">
            ...
            <a 
              ...
              className="text-(--text-color) hover:text-(--text-color-white) transition-colors duration-300"
            >
            ...
            {linkedIn && (
              <>
                ...
                <a
                  ...
                  className="text-(--text-color) hover:text-(--text-color-white) transition-all duration-300 hover:scale-110 inline-flex items-center gap-2"
                  title={linkedIn.name}
                >
