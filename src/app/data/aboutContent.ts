...
export const aboutContent: AboutContent = {
  ...
  aboutMe:
    "Selam, ben Mete! 20 yaşında bir Yazılım Mühendisliği öğrencisiyim. Şu anda Kocaeli'de yaşıyorum ve sektörün kalbinde kendimi harmanlamak için elimden geleni yapıp kendimi geliştiriyorum. Size bir sır: Şarkı söylemeyi ve yemek yemeyi çok severim.",
  sectionTitles: {
    about: 'Hakkımda',
